...
{
	private:
		OLChannel(); // Default constructor is private - have to initiate it with a channel number
...
//		HANDLE ChanPipe;
		...
		unsigned short _20ms_epoch; // Counter of 20 millisecond epochs (data bit counter)
